(() => {
  ...
  /* ----------------------------------------------------------------------
     ...
     ---------------------------------------------------------------------- */
  const revealSelector = ".reveal, .reveal-up, .reveal-fade, .reveal-left, .reveal-right, .reveal-scale, .reveal-diagonal";
  ...
  if (menuNav && menuSections.length) {
    const links = [...menuNav.querySelectorAll("a[href^='#']")];
  ...
  /* ----------------------------------------------------------------------
     Contact form placeholder (static site — not connected to a backend)
     ---------------------------------------------------------------------- */
  if (contactForm) {
